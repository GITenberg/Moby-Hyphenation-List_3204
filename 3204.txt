...
Title:  Moby Hyphenator II

Author:  Grady Ward, grady@gradyward.com

Release Date:  May, 2002  [Etext #3204]

Edition:  1.0

The Project Gutenberg Etext of Moby Hyphenator II by Grady Ward
******This file should be named 3204.txt******
...
Moby (tm) Hyphenator II for MSDOS operating systems is compressed
...
After self-decompression the vocabulary files included with this
product are in ordinary ASCII format with CRLF (ASCII 13/10)
delimiters.  The hyphenation marks are indicated with ASCII 165
character, which is significant in alphabetization.

Note that words that ought *not* to be hyphenated are included for
completeness.
...
End of this Project Gutenberg etext of Moby Hyphenator II by Grady Ward.
